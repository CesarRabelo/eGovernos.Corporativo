<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="frmEconomicaDeReceita.aspx.cs" Inherits="Platinium.Web.EconomicaDeReceita" %>
                            ...
                            <div class="obj_Conteudo txt_padrao">
                                <pro:ProGridView ID="grdListagem" runat="server" AllowPaging="True" AllowSorting="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Codigo" HeaderText="Código" ItemStyle-Width="5%" ItemStyle-HorizontalAlign="left"
                                            SortExpression="Codigo" HeaderStyle-HorizontalAlign="left">
                                            <ItemStyle Width="5%" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Descricao" HeaderStyle-HorizontalAlign="Left" HeaderText="Descrição"
                                            ItemStyle-Width="85%" SortExpression="Descricao">
                                    ...
                                    <tr>
                                        <td class="linha_rotulo" style="height: 15px">
                                            ...
                                            <pro:ProTextBox ID="txtCod2" CssClass="obj_Controle_Obrigatorio" CssClassFocus="obj_Controle_Obrigatorio_Focus"
                                                runat="server" MaxLength="1" Width="20px" Enabled="false" BackColor="#cccccccc"></pro:ProTextBox>
                                            ...
                                            <pro:ProTextBox ID="txtCodigo" CssClass="obj_Controle_Obrigatorio" CssClassFocus="obj_Controle_Obrigatorio_Focus"
                                                ToolTip="Informe o código da categoria econômia da receita." DataField="Codigo"
                                                Label="Código:" runat="server" MaxLength="8" Width="20px" Visible="false"></pro:ProTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="linha_rotulo" colspan="3" style="height: 15px">
                                            <pro:ProTextBox ID="txtDescricao" runat="server" CssClass="obj_Controle_Obrigatorio_M"
                                                CssClassFocus="obj_Controle_Obrigatorio_Focus_M" ToolTip="Informe a descrição da categoria econômia da receita."
