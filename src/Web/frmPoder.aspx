<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="frmPoder.aspx.cs" Inherits="Platinium.Web.Poder" %>
                                ...
                                <pro:ProGridView ID="grdListagem" runat="server" AllowPaging="True" AllowSorting="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="DscAtivo" HeaderStyle-HorizontalAlign="left" HeaderText="Ativo"
                                            ItemStyle-Width="5%" SortExpression="DscAtivo" ItemStyle-HorizontalAlign="left">
                                            <HeaderStyle HorizontalAlign="left" />
                                            <ItemStyle Width="5%" />
                                        </asp:BoundField>
                        ...
                        <div class="obj_Conteudo txt_padrao">
                            <pro:ProPanel ID="pnlManutencao" runat="server" BorderWidth="0px" Height="100%" Width="100%">
                                ...
                                <table align="center" border="0" cellpadding="0" cellspacing="0" width="95%" style="vertical-align: top;
                                    ...
                                    <tr>
                                        <td class="linha_rotulo" style="height: 15px; width: 120px;" colspan="0">
                                            <pro:ProTextBox ID="txtCodigo" CssClass="obj_Controle_Obrigatorio_P" CssClassFocus="obj_Controle_Obrigatorio_Focus_P"
                                                ToolTip="Informe o código do poder." DataField="Codigo" Label="Código:" runat="server"
                                                MaxLength="2"></pro:ProTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="linha_rotulo" colspan="3" style="height: 15px; width: 268435328px;">
                                            <pro:ProTextBox ID="txtDescricao" runat="server" CssClass="obj_Controle_Obrigatorio_M"
                                                CssClassFocus="obj_Controle_Obrigatorio_Focus_M" ToolTip="Informe a descrição do poder."
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="0" style="width: 120px">
                                            &nbsp;
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="linha_rotulo" style="height: 15px; width: 120px;">
