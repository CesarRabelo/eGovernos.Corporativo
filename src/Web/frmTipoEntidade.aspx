<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="frmTipoEntidade.aspx.cs" Inherits="Platinium.Web.TipoEntidade" %>
                            ...
                            <div class="obj_Conteudo txt_padrao">
                                <pro:ProGridView ID="grdListagem" runat="server" AllowPaging="True" AllowSorting="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Codigo" HeaderText="Código" SortExpression="Codigo" HeaderStyle-HorizontalAlign="Left"
                                            ItemStyle-Width="5%"></asp:BoundField>
                                        <asp:BoundField DataField="Descricao" HeaderStyle-HorizontalAlign="Left" HeaderText="Descrição"
                                            ItemStyle-Width="65%" SortExpression="Descricao"></asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="DscAtivo" HeaderText="Ativo" HeaderStyle-HorizontalAlign="Left"
                                            SortExpression="DscAtivo" ItemStyle-Width="5%" ItemStyle-HorizontalAlign="left" />
                                    </Columns>
                                    ...
                                    <tr>
                                        <td class="linha_rotulo" style="height: 15px">
                                            <pro:ProTextBox ID="txtCodigo" CssClass="obj_Controle_Obrigatorio_P" CssClassFocus="obj_Controle_Obrigatorio_Focus_P"
                                                ToolTip="Informe o código do tipo de entidade." DataField="Codigo" Label="Código:"
                                    ...
                                    <tr>
                                        <td class="linha_rotulo" colspan="3" style="height: 15px">
                                            <pro:ProTextBox ID="txtDescricao" runat="server" CssClass="obj_Controle_Obrigatorio_M"
                                                CssClassFocus="obj_Controle_Obrigatorio_Focus_M" ToolTip="Informe a descrição do tipo de entidade."
