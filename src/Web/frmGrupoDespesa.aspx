<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="frmGrupoDespesa.aspx.cs" Inherits="Platinium.Web.GrupoDespesa"
    Title="Untitled Page" %>
                                    ...
                                    <tr>
                                        <td class="linha_rotulo" style="height: 15px" width="120">
                                            <pro:ProTextBox ID="txtCodigo" runat="server" CssClass="obj_Controle_Obrigatorio_P"
                                                ...
                                                LabelPosition="Top" MaxLength="1" ToolTip="Informe o código do grupo de despesa."></pro:ProTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="linha_rotulo" colspan="3" style="height: 15px">
                                            <pro:ProTextBox ID="txtDescricao" runat="server" CssClass="obj_Controle_Obrigatorio_M"
                                                ...
                                                LabelPosition="Top" ToolTip="Informe a descrição do grupo de despesa."></pro:ProTextBox>
                                        </td>
                                    </tr>
                                    <tr>
