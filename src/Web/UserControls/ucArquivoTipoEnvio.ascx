<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucArquivoTipoEnvio.ascx.cs"
    Inherits="Platinium.Web.ucArquivoTipoEnvio" %>
<%@ Register Assembly="Pro.Controls" Namespace="Pro.Controls" TagPrefix="pro" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<pro:ProPanel ID="pnlConsultaUC" runat="server" Width="650px" GroupingText="Tipo de Envio">
    ...
    <pro:ProGridView ID="grdListagemUC" runat="server" CssClass="obj_Grid" GridLines="None"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="DscTipoEnvio" HeaderText="Tipo de Envio" HeaderStyle-HorizontalAlign="Left"
                ItemStyle-Width="100%" SortExpression="DscTipoEnvio" ItemStyle-HorizontalAlign="Left"></asp:BoundField>
        </Columns>
        <EmptyDataRowStyle CssClass="obj_Grid_Row_Nao_Localizado" />
    </pro:ProGridView>
    <div style="text-align: right">
        <asp:Button ID="btnNovoUC" runat="server" Text="Novo Envio" CssClass="obj_Btn_Box" />
    </div>
</pro:ProPanel>
                ...
                <div id="LAY_CONTENT_RIGHT_POPUP">
                    ...
                    <tr>
                            <td style="width: 120px">
                                <pro:ProDropDownList ID="ddlTipoEnvio" CssClass="obj_Controle_Obrigatorio_M"
                                    CssClassFocus="obj_Controle_Obrigatorio_Focus_M" ToolTip="Informe tipo de envio do arquivo."
                                    DataField="TipoEnvio" Label="Tipo de Envio:" runat="server"
                                    DataType="Number" DefaultText="Selecione o tipo de envio.">
                                </pro:ProDropDownList>
                            </td>
                        </tr>
                    </table>
