<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="frmGrupoFonte.aspx.cs" Inherits="Platinium.Web.GrupoFonte" %>
                                ...
                                <pro:ProGridView ID="grdListagem" runat="server" AllowPaging="True" AllowSorting="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Descricao" HeaderStyle-HorizontalAlign="Left" HeaderText="Descrição"
                                            ItemStyle-HorizontalAlign="Left" ItemStyle-Width="45%" SortExpression="Descricao">
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle Width="45%" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="DscPai" HeaderText="Grupo Pai" SortExpression="DscPai"
                                            HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="45%" ItemStyle-HorizontalAlign="Left">
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </asp:BoundField>
                                    </Columns>
                                    ...
                                    <tr>
                                        <td class="linha_rotulo" style="height: 15px">
                                            <pro:ProTextBox ID="txtCodigo" CssClass="obj_Controle_Obrigatorio_P" CssClassFocus="obj_Controle_Obrigatorio_Focus_P"
                                                ToolTip="Informe o código do grupo fonte." DataField="Codigo" Label="Código:"
                                    ...
                                    <tr>
                                        <td class="linha_rotulo" colspan="3" style="height: 15px">
                                            <pro:ProTextBox ID="txtDescricao" runat="server" CssClass="obj_Controle_Obrigatorio_M"
                                                CssClassFocus="obj_Controle_Obrigatorio_Focus_M" ToolTip="Informe a descrição do grupo fonte."
                                                DataField="Descricao" Label="Descrição:"></pro:ProTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="linha_rotulo" colspan="3" style="height: 15px">
                                            <pro:ProDropDownList ID="ddlGrupoPai" runat="server" CssClass="obj_Controle_M" CssClassFocus="obj_Controle_Focus_M"
                                                DataType="Number" ToolTip="Informe o grupo fonte pai." DefaultText="Selecione o grupo fonte pai."
                                                DataField="GrupoPai" Label="Grupo de fonte pai:">
                                            </pro:ProDropDownList>
                                        </td>
                                    </tr>
                                    <tr>
