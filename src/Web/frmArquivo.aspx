<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="frmArquivo.aspx.cs" Inherits="Platinium.Web.Arquivo" %>
...
<%@ Register Src="UserControls/ucArquivoColuna.ascx" TagName="ucArquivoColuna" TagPrefix="uc1" %>
<%@ Register Src="UserControls/ucArquivoTipoEnvio.ascx" TagName="ucArquivoTipoEnvio"
    TagPrefix="uc2" %>
<%@ Register Src="UserControls/ucArquivoResponsavel.ascx" TagName="ucArquivoResponsavel"
    TagPrefix="uc3" %>
                                ...
                                <pro:ProGridView ID="grdListagem" runat="server" AllowPaging="True" AllowSorting="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Codigo" HeaderStyle-HorizontalAlign="Left" HeaderText="Código"
                                            ItemStyle-Width="5%" SortExpression="Nome">
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle Width="5%" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Nome" HeaderStyle-HorizontalAlign="Left" HeaderText="Nome"
                                            ItemStyle-Width="35%" SortExpression="Nome">
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle Width="35%" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="DscTipoEnvio" HeaderStyle-HorizontalAlign="Left" HeaderText="Tipo de Envio"
                                            ItemStyle-Width="30%" SortExpression="DscTipoEnvio">
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle Width="30%" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="DscResponsavelEnvio" HeaderStyle-HorizontalAlign="Left"
                                            HeaderText="Responsável de Envio" ItemStyle-Width="25%" SortExpression="DscResponsavelEnvio">
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle Width="25%" />
                                        </asp:BoundField>
                                    </Columns>
                        ...
                        <div class="obj_Conteudo txt_padrao">
                            <pro:ProPanel ID="pnlManutencao" runat="server" BorderWidth="0px" Height="100%" Width="100%">
                                ...
                                <table align="center" border="0" cellpadding="0" cellspacing="0" width="95%" style="vertical-align: top;
                                    ...
                                    <tr>
                                        <td class="linha_rotulo" style="height: 15px">
                                            <pro:ProTextBox ID="txtCodigo" CssClass="obj_Controle_Obrigatorio_P" CssClassFocus="obj_Controle_Obrigatorio_Focus_P"
                                                ToolTip="Informe o código do arquivo." DataField="Codigo" Label="Código:" runat="server"
                                                MaxLength="3"></pro:ProTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="linha_rotulo" style="height: 15px">
                                            <pro:ProTextBox ID="txtPrefixo" CssClass="obj_Controle_Obrigatorio_P" CssClassFocus="obj_Controle_Obrigatorio_Focus_P"
                                                ToolTip="Informe o prefixo do arquivo." DataField="Prefixo" Label="Prefixo:"
                                                runat="server" MaxLength="10"></pro:ProTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="linha_rotulo" style="height: 15px">
                                            <pro:ProTextBox ID="txtMascara" CssClass="obj_Controle_Obrigatorio_P" CssClassFocus="obj_Controle_Obrigatorio_Focus_P"
                                                ToolTip="Informe a máscara do arquivo." DataField="Mascara" Label="Máscara:"
                                                runat="server" MaxLength="10"></pro:ProTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="linha_rotulo" style="height: 15px">
                                            <pro:ProTextBox ID="txtNome" CssClass="obj_Controle_Obrigatorio_M" CssClassFocus="obj_Controle_Obrigatorio_Focus_M"
                                                ToolTip="Informe o nome do arquivo." DataField="Nome" Label="Nome:" runat="server"
                                                MaxLength="100"></pro:ProTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="linha_rotulo" style="height: 15px">
                                            <pro:ProDropDownList ID="ddlGrupoArquivo" runat="server" CssClass="obj_Controle_Obrigatorio_M"
                                                CssClassFocus="obj_Controle_Obrigatorio_Focus_M" ToolTip="Informe o grupo do arquivo."
                                                DataField="GrupoArquivo" Label="Grupo do arquivo:" DataType="Number" LabelPosition="Top"
                                                DefaultText="Selecione o grupo do arquivo">
                                            </pro:ProDropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="linha_rotulo" style="height: 15px; width: 100%;">
                                            <uc3:ucArquivoResponsavel ID="ucArquivoResponsavel1" runat="server" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="linha_rotulo" style="height: 15px; width: 100%;">
                                            <uc2:ucArquivoTipoEnvio ID="ucArquivoTipoEnvio1" runat="server" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="linha_rotulo" style="height: 15px; width: 100%;">
                                            <uc1:ucArquivoColuna ID="ucArquivoColuna1" runat="server" />
                                        </td>
                                    </tr>
                                </table>
                            </pro:ProPanel>
