<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="frmFormaIngresso.aspx.cs" Inherits="Platinium.Web.frmFormaIngresso" %>
                                ...
                                <pro:ProGridView ID="grdListagem" runat="server" AllowPaging="True" AllowSorting="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Codigo" HeaderStyle-HorizontalAlign="Left" HeaderText="Código"
                                            ItemStyle-Width="10%" SortExpression="Codigo">
                                        ...
                                        <asp:BoundField DataField="DscAtivo" HeaderStyle-HorizontalAlign="Left" HeaderText="Ativo"
                                            ItemStyle-Width="10%" SortExpression="DscAtivo">
                                            <HeaderStyle HorizontalAlign="Center" Width="10%" />
                                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                                        </asp:BoundField>
                                    </Columns>
                                    ...
                                    <tr>
                                        <td class="linha_rotulo" style="height: 15px">
                                            <pro:ProTextBox ID="txtCodigo" CssClass="obj_Controle_Obrigatorio" CssClassFocus="obj_Controle_Obrigatorio_Focus"
                                                ToolTip="Informe o código." DataField="Codigo" Label="Código:" runat="server"
