...
{
    public partial class frmRegimePrevidenciario : PaginaCadastroBase
    {
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                PaginaSegura = false;
                this.TituloPagina = "Regime Previdenciário";
                this.Controladora = new ManterRegimePrevidenciario();
