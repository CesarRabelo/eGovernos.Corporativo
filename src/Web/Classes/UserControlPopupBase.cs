...
namespace Web
{
    ...
    /// </summary>
    public class UserControlPopupBase : System.Web.UI.UserControl
    {
        #region Propriedades
        /// <summary>
        ...
        protected object Controladora
        {
            get
            {
                ...
                if (Cache[ViewState["$ControladoraPopup$"].ToString()] == null)
                    throw new Exception("Controladora não encontrada.");
                return Cache[ViewState["$ControladoraPopup$"].ToString()];
            }
            set
            {
                if (ViewState["$ControladoraPopup$"] == null)
                ...
                Cache.Insert(ViewState["$ControladoraPopup$"].ToString(), value, null, System.Web.Caching.Cache.NoAbsoluteExpiration, TimeSpan.FromMinutes(20), System.Web.Caching.CacheItemPriority.NotRemovable, null);
        ...
        {
            get { return ViewState["$TituloPaginaPopup$"] == null ? "" : ViewState["$TituloPaginaPopup$"].ToString(); }
            set { ViewState["$TituloPaginaPopup$"] = value; }
        }
