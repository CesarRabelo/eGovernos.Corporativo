<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="frmCargo.aspx.cs" Inherits="Platinium.Web.frmCargo" %>
                            ...
                            <div class="obj_Conteudo txt_padrao">
                                <pro:ProGridView ID="grdListagem" runat="server" AllowPaging="True" AllowSorting="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="DescricaoCargo" HeaderText="Descrição" ItemStyle-Width="90%"
                                            SortExpression="DescricaoCargo" HeaderStyle-HorizontalAlign="Left">
                                            <ItemStyle Width="90%" />
                                            <HeaderStyle Width="90%" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Ativo" HeaderText="Ativo" ItemStyle-Width="10%"
                                            SortExpression="Ativo" HeaderStyle-HorizontalAlign="Left">
                                            <ItemStyle Width="10%" />
                                    ...
                                    <tr>
                                        <td class="linha_rotulo" style="height: 15px" colspan="2">
                                            <pro:ProTextBox ID="txtDescricao" runat="server" CssClass="obj_Controle_Obrigatorio"
                                                ...
                                                DataField="DescricaoCargo" Label="Descrição:" Width="300px"></pro:ProTextBox>
                                        </td>
                                    </tr>
                                     <tr>
                                        <td class="linha_rotulo" style="height: 15px" colspan="2">
