<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="frmProduto.aspx.cs" Inherits="Platinium.Web.Produto" %>
                ...
                <div id="LAY_FILTRO">
                    <pro:ProPanel ID="pnlConsulta" GroupingText="Filtros para busca" runat="server">
                        <table width="100%">
                            <tr>
                                <td>
                                    <asp:Label ID="lblUnidade" runat="server" Text="Unidade:" CssClass="LabelFiltro"></asp:Label>
                                </td>
                                <td>
                                    <pro:ProDropDownList ID="ddlBuscaUnidade" runat="server" CssClass="obj_Controle_M"
                                        CssClassFocus="obj_Controle_Focus_M" ToolTip="Informe a Unidade a ser filtrada"
                                        DefaultText="Todas as Unidades" DataField="Unidade" DataType="Number" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <pro:ProDropDownList ID="ddlCampoBusca" Width="130px" runat="server" CssClass="obj_Controle" />
                                    <asp:Label ID="lblBusca" runat="server"></asp:Label><pro:ProTextBox ID="txtBusca"
                                        runat="server" Width="108px" CssClass="obj_Controle" ToolTip="Informe o texto para busca."></pro:ProTextBox>
                                </td>
                                <td align="right">
                            ...
                            <div class="obj_Conteudo txt_padrao">
                                <pro:ProGridView ID="grdListagem" runat="server" AllowPaging="True" AllowSorting="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="DscUnidade" HeaderStyle-HorizontalAlign="Left" HeaderText="Unidade"
                                            ItemStyle-Width="10%" SortExpression="DscUnidade">
                                        ...
                                        <asp:BoundField DataField="Descricao" HeaderStyle-HorizontalAlign="Left" HeaderText="Descrição"
                                            ItemStyle-Width="55%" SortExpression="Descricao">
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle Width="55%" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="DataCriado" HeaderText="Data de Criação" ItemStyle-Width="10%"
                                            SortExpression="DataCriado" HeaderStyle-HorizontalAlign="Left" DataFormatString="{0:dd/MM/yyyy}">
                                            <ItemStyle Width="10%" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="DataDesativado" HeaderText="Data de Desativação" ItemStyle-Width="10%"
                                            SortExpression="DataDesativado" HeaderStyle-HorizontalAlign="Left" DataFormatString="{0:dd/MM/yyyy}">
                                            <ItemStyle Width="10%" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="DscAtivo" HeaderText="Ativo" SortExpression="DscAtivo"
                                            HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="5%" />
                                    </Columns>
                                    ...
                                    <tr>
                                        <td class="linha_rotulo" colspan="3" style="height: 15px">
                                            <pro:ProTextBox ID="txtCodigo" runat="server" CssClass="obj_Controle_Obrigatorio_P"
                                                CssClassFocus="obj_Controle_Obrigatorio_Focus_P" ToolTip="Informe o código do produto."
                                                DataField="Codigo" Label="Código:" MaxLength="4"></pro:ProTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="linha_rotulo" colspan="3" style="height: 15px">
                                            <pro:ProTextBox ID="txtDescricao" runat="server" CssClass="obj_Controle_Obrigatorio_M"
                                                CssClassFocus="obj_Controle_Obrigatorio_Focus_M" ToolTip="Informe a descrição do produto."
                                                DataField="Descricao" Label="Descrição:"></pro:ProTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="linha_rotulo" colspan="3" style="height: 15px">
                                            <pro:ProDropDownList ID="ddlUnidade" runat="server" CssClass="obj_Controle_Obrigatorio_M"
                                                CssClassFocus="obj_Controle_Obrigatorio_Focus_M" ToolTip="Informe a unidade do produto."
                                                DataField="Unidade" Label="Unidade:" DataType="Number" LabelPosition="Top" DefaultText="Selecione a unidade">
                                            </pro:ProDropDownList>
                                        </td>
                                    </tr>
                                    <tr>
