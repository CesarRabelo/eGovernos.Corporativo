...
{
    public partial class EconomicaDeDespesa : PaginaCadastroBase
    {
        protected override void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                this.TituloPagina = "Categoria Econômica De Despesa";
                this.Controladora = new ManterEconomicaDeDespesa();
