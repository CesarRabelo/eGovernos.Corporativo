<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="frmTaxa.aspx.cs" Inherits="Platinium.Web.Taxa" %>
                                ...
                                <pro:ProGridView ID="grdListagem" runat="server" AllowPaging="True" AllowSorting="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Codigo" HeaderStyle-HorizontalAlign="Left" HeaderText="Código"
                                            ItemStyle-Width="5%" SortExpression="Codigo"></asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="Descricao" HeaderStyle-HorizontalAlign="Left" HeaderText="Descrição"
                                            ItemStyle-Width="70%" SortExpression="Descricao"></asp:BoundField>
                                        <asp:BoundField DataField="Definicao" HeaderStyle-HorizontalAlign="Left" HeaderText="Definicao"
                                            ItemStyle-Width="10%" SortExpression="Definicao"></asp:BoundField>
                                    ...
                                    <tr>
                                        <td class="linha_rotulo" style="height: 15px">
                                            <pro:ProTextBox ID="txtCodigo" CssClass="obj_Controle_Obrigatorio_P" CssClassFocus="obj_Controle_Obrigatorio_Focus_P"
                                                ToolTip="Informe o código da taxa." DataField="Codigo" Label="Código:" runat="server"
                                                MaxLength="5"></pro:ProTextBox>
                                        </td>
                                        <td class="linha_rotulo" colspan="0" style="height: 15px">
                                            <pro:ProTextBox ID="txtSigla" runat="server" CssClass="obj_Controle_P" CssClassFocus="obj_Controle_Focus_P"
                                                ToolTip="Informe a sigla da taxa." DataField="Sigla" MaxLength="10" Label="Sigla:"></pro:ProTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="linha_rotulo" colspan="2" style="height: 15px">
                                            <pro:ProTextBox ID="txtDescricao" runat="server" CssClass="obj_Controle_Obrigatorio_M"
                                                CssClassFocus="obj_Controle_Obrigatorio_Focus_M" ToolTip="Informe a descrição da taxa."
                                                DataField="Descricao" MaxLength="50" Label="Descrição:"></pro:ProTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="linha_rotulo" colspan="2" style="height: 15px">
                                            <pro:ProTextBox ID="txtDefinicao" runat="server" CssClass="obj_Controle_M" CssClassFocus="obj_Controle_Focus_M"
                                                ToolTip="Informe a definição da taxa." DataField="Definicao" MaxLength="500"
                                                Label="Definição:" TextMode="MultiLine" Rows="3"></pro:ProTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
