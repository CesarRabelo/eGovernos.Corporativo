<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="frmGrupoPrograma.aspx.cs" Inherits="Platinium.Web.GrupoPrograma" %>
                ...
                <div id="LAY_FILTRO">
                    <pro:ProPanel ID="pnlConsulta" GroupingText="Filtros para busca" runat="server">
                        <table width="100%">
                            <tr>
                                <td>
                                    <asp:Label ID="lblTipoPrograma" runat="server" Text="Tipo de Programa:" CssClass="LabelFiltro"></asp:Label>
                                </td>
                                <td>
                                    <pro:ProDropDownList ID="ddlBuscaTipo" runat="server" CssClass="obj_Controle_M" CssClassFocus="obj_Controle_Focus_M"
                                        ToolTip="Informe o tipo de programa a ser filtrado." DefaultText="Todos os tipos de programa."
                                        DataField="TipoPrograma" DataType="Number" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    ...
                                    <asp:Label ID="lblBusca" runat="server"></asp:Label><pro:ProTextBox ID="txtBusca"
                                        runat="server" Width="121px" CssClass="obj_Controle" ToolTip="Informe o texto para busca."></pro:ProTextBox>
                                </td>
                                <td align="right">
                            ...
                            <div class="obj_Conteudo txt_padrao">
                                <pro:ProGridView ID="grdListagem" runat="server" AllowPaging="True" AllowSorting="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="descricaoPrograma" HeaderStyle-HorizontalAlign="Left"
                                            HeaderText="Tipo de Programa" ItemStyle-Width="40%" SortExpression="descricaoPrograma">
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle Width="40%" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="DscAtivo" HeaderText="Ativo" SortExpression="DscAtivo"
                                            HeaderStyle-HorizontalAlign="Left" ItemStyle-Height="5%" ItemStyle-HorizontalAlign="Left">
                                            <ItemStyle Width="5%" />
                                        </asp:BoundField>
                                    </Columns>
                                    ...
                                    <tr>
                                        <td class="linha_rotulo" style="height: 15px">
                                            <pro:ProTextBox ID="txtCodigo" CssClass="obj_Controle_Obrigatorio_P" CssClassFocus="obj_Controle_Obrigatorio_Focus_P"
                                                ToolTip="Informe o código do grupo de programa." DataField="Codigo" Label="Código:"
                                    ...
                                    <tr>
                                        <td class="linha_rotulo" colspan="3" style="height: 15px">
                                            <pro:ProTextBox ID="txtDescricao" runat="server" CssClass="obj_Controle_Obrigatorio_M"
                                                CssClassFocus="obj_Controle_Obrigatorio_Focus_M" ToolTip="Informe a descrição do grupo programa."
                                                DataField="Descricao" Label="Descrição:"></pro:ProTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="linha_rotulo" colspan="3" style="height: 15px">
                                            <pro:ProDropDownList ID="ddlTipoPrograma" runat="server" CssClass="obj_Controle_Obrigatorio_M"
                                                CssClassFocus="obj_Controle_Obrigatorio_Focus_M" ToolTip="Informe o tipo do grupo de programa."
                                                DataField="TipoPrograma" Label="Tipo de Programa:" DataType="Number" LabelPosition="Top"
                                                DefaultText="Selecione o tipo do grupo de programa">
                                            </pro:ProDropDownList>
                                        </td>
                                    </tr>
                                    <tr>
