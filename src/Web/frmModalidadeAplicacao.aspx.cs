...
{
    public partial class ModalidadeAplicacao : PaginaCadastroBase
    {
        protected override void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                this.TituloPagina = "Modalidade de aplicação";
                this.Controladora = new ManterModalidadeAplicacao();
        ...
        protected override void btnNovo_Click(object sender, EventArgs e)
        {
            ...
            chkCorrespondente.Checked = true;
        }
