<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="frmMoeda.aspx.cs" Inherits="Platinium.Web.Moeda" %>
                            ...
                            <div class="obj_Conteudo txt_padrao">
                                <pro:ProGridView ID="grdListagem" runat="server" AllowPaging="True" AllowSorting="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="DescricaoCifra" HeaderStyle-HorizontalAlign="Left" HeaderText="Cifra"
                                            ItemStyle-Width="90%" SortExpression="DescricaoCifra">
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle Width="70%" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="DescricaoMoeda" HeaderStyle-HorizontalAlign="Left" HeaderText="Moeda"
                                            ItemStyle-Width="90%" SortExpression="DescricaoMoeda">
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle Width="70%" />
                                        </asp:BoundField>
                                    </Columns>
                                ...
                                <table align="center" border="0" cellpadding="0" cellspacing="0" width="95%" style="vertical-align: top;
                                    ...
                                    <tr>
                                        <td class="linha_rotulo" colspan="3" style="height: 15px">
                                            <pro:ProTextBox ID="txtDescricaoCifra" runat="server" CssClass="obj_Controle_Obrigatorio_G"
                                                CssClassFocus="obj_Controle_Obrigatorio_Focus_G" ToolTip="Informe a descrição da cifra."
                                                DataField="DescricaoCifra" Label="Cifra:"></pro:ProTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="linha_rotulo" colspan="3" style="height: 15px">
                                            <pro:ProTextBox ID="txtDescricaoMoeda" runat="server" CssClass="obj_Controle_Obrigatorio_G"
                                                CssClassFocus="obj_Controle_Obrigatorio_Focus_G" ToolTip="Informe a descrição da moeda."
                                                DataField="DescricaoMoeda" Label="Moeda:"></pro:ProTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
