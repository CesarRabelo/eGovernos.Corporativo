...
namespace Platinium.Entidade
{
    ...
    public class FormaIngresso
    {
        ...
        [PropertyAttribute(Field = "COD_FORMA_INGRESSO", Description = "Código", AllowNull = false, PropertyType = PropertyCategories.Field)]
        ...
        [PropertyAttribute(Field = "DSC_FORMA_INGRESSO", Description = "Descrição", AllowNull = false, PropertyType = PropertyCategories.Field)]
