...
{
    [ClassAttribute(Schema = "platinium", Table = "TB_CAT_ECONOMICA_DESPESA_CAED ")]
    public class EconomicaDeDespesa
    {
        ...
        [PropertyAttribute(Field = "ID_CAT_ECONOMICA_DESPESA_CAED", AllowNull = false, PropertyType = PropertyCategories.PrimaryKey, Variable = "iID")]
        public int ID
        {
            get { return iID; }
        }
        ...
        [PropertyAttribute(Field = "COD_CAT_ECONOMICA_DESPESA_CAED", AllowNull = false, Description="Código", PropertyType = PropertyCategories.Field)]
        public string Codigo
        {
            get;
            set;
        }
        [PropertyAttribute(Field = "DSC_CAT_ECONOMICA_DESPESA_CAED", AllowNull = false, Description="Descrição", PropertyType = PropertyCategories.Field)]
        ...
        #region Construtores
        public EconomicaDeDespesa() { }
		public EconomicaDeDespesa(Dao dao)
		{
			oDao = dao;
		}

        public EconomicaDeDespesa(int id, Dao dao)
		{
        ...
        public EconomicaDeDespesa(string codigo, Dao dao)
        {
            List<Parameter> parametro = new List<Parameter>();
        ...
        private void ValidarCodigoCadastrado()
        {
            ...
            if (oDao.Select(parametro, "platinium", "TB_CAT_ECONOMICA_DESPESA_CAED", typeof(EconomicaDeDespesa)).Rows.Count != 0)
                throw new RegraNegocioException("Grupo de despesa já cadastrada com o código informado");
        }
        ...
        private void ValidarDescricaoCadastrado()
        {
            ...
            if (oDao.Select(parametro, "platinium", "TB_CAT_ECONOMICA_DESPESA_CAED", typeof(EconomicaDeDespesa)).Rows.Count != 0)
                throw new RegraNegocioException("Grupo de despesa já cadastrada com a descrição informado");
        }
