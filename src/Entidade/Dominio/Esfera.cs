...
{
    [ClassAttribute(Schema = "platinium", Table = "TB_ESFERA_ESFE")]
    public class Esfera
    {
        ...
        [PropertyAttribute(Field = "ID_ESFERA_ESFE", AllowNull = false, PropertyType = PropertyCategories.PrimaryKey, Variable = "iID")]
        public int ID
        {
            get { return iID; }
        }
        ...
        [PropertyAttribute(Field = "COD_ESFERA", AllowNull = false, Description="Código", PropertyType = PropertyCategories.Field)]
        public string Codigo
        {
            get;
            set;
        }
        [PropertyAttribute(Field = "DSC_ESFERA", AllowNull = false, Description="Descrição", PropertyType = PropertyCategories.Field)]
        ...
        #region Construtores
        public Esfera() { }
		public Esfera(Dao dao)
		{
			oDao = dao;
		}

        public Esfera(int id, Dao dao)
		{
        ...
        private void ValidarCodigoCadastrado()
        {
            ...
            if (oDao.Select(parametro, "platinium", "TB_ESFERA_ESFE", typeof(Esfera)).Rows.Count != 0)
                throw new RegraNegocioException("Esfera já cadastrada com o código informado");
        }
        ...
        private void ValidarDescricaoCadastrado()
        {
            ...
            if (oDao.Select(parametro, "platinium", "TB_ESFERA_ESFE", typeof(Esfera)).Rows.Count != 0)
                throw new RegraNegocioException("Esfera já cadastrada com a descrição informada");
        }
