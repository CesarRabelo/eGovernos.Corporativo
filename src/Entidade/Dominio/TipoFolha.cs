...
{
    [ClassAttribute(Schema = "plutonium", Table = "TB_TIPO_FOLHA_PAGAMENTO_TIFP")]
    public class TipoFolha
    {
        ...
        [PropertyAttribute(Field = "ID_TIPO_FOLHA_PAGAMENTO", AllowNull = false, PropertyType = PropertyCategories.PrimaryKey, Variable = "iID")]
        public int ID
        {
            get { return iID; }
        }

        [PropertyAttribute(Field = "COD_TIPO_FOLHA_PAGAMENTO", Description = "Código", AllowNull = false, PropertyType = PropertyCategories.Field, Size=2)]
        ...
        [PropertyAttribute(Field = "DSC_TIPO_FOLHA_PAGAMENTO", Description = "Descrição", AllowNull = false, PropertyType = PropertyCategories.Field, Size = 50)]
        ...
        #region Construtores
        public TipoFolha() { }
        public TipoFolha(Dao dao)
        {
            oDao = dao;
        }

        public TipoFolha(int id, Dao dao)
        {
