...
{
    [ClassAttribute(Schema = "plutonium", Table = "TB_TIPO_DESLIGAMENTO_TIDE")]
    public class TipoDesligamento
    {
        ...
        [PropertyAttribute(Field = "ID_TIPO_DESLIGAMENTO", AllowNull = false, PropertyType = PropertyCategories.PrimaryKey, Variable = "iID")]
        public int ID
        {
            get { return iID; }
        }

        [PropertyAttribute(Field = "COD_TIPO_DESLIGAMENTO", AllowNull = false, Description = "Código", PropertyType = PropertyCategories.Field)]
        ...
        [PropertyAttribute(Field = "DSC_TIPO_DESLIGAMENTO", AllowNull = false, Description = "Descrição", PropertyType = PropertyCategories.Field)]
		...
		public TipoDesligamento(Dao dao)
		{
			oDao = dao;
		}

        public TipoDesligamento(int id, Dao dao)
		{
