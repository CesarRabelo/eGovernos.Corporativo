...
namespace Platinium.Entidade
{
    ...
    public class TipoPisPasep
    {
        ...
        [PropertyAttribute(Field = "DSC_TIPO_PIS_PASEP", Description = "Descrição", AllowNull = false, PropertyType = PropertyCategories.Field)]
        ...
        [PropertyAttribute(Field = "COD_TIPO_PIS_PASEP", Description = "Código", AllowNull = false, PropertyType = PropertyCategories.Field)]
