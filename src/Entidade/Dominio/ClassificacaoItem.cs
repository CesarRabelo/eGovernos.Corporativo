...
{
    [ClassAttribute(Schema = "plutonium", Table = "TB_CLASSIFICACAO_ITEM_REMUNERATORIO_CLIR")]
    public class ClassificacaoItem
    {
        ...
        [PropertyAttribute(Field = "ID_CLASSIFICACAO_ITEM_REMUNERATORIO", AllowNull = false, PropertyType = PropertyCategories.PrimaryKey, Variable = "iID")]
        public int ID
        {
            get { return iID; }
        }

        [PropertyAttribute(Field = "COD_CLASSIFICACAO_ITEM_REMUNERATORIO", Description = "Código", AllowNull = false, PropertyType = PropertyCategories.Field, Size = 2)]
        public char Codigo
        {
            get;
            set;
        ...
        [PropertyAttribute(Field = "DSC_CLASSIFICACAO_ITEM_REMUNERATORIO", Description = "Descrição", AllowNull = false, PropertyType = PropertyCategories.Field, Size = 50)]
        ...
        public ClassificacaoItem(Dao dao)
        {
            oDao = dao;
        }

        public ClassificacaoItem(int id, Dao dao)
        {
