...
{
    [ClassAttribute(Schema = "plutonium", Table = "TB_TIPO_ITEM_REMUNERATORIO_TIIR")]
    public class TipoItem
    {
        ...
        [PropertyAttribute(Field = "ID_TIPO_ITEM_REMUNERATORIO", AllowNull = false, PropertyType = PropertyCategories.PrimaryKey, Variable = "iID")]
        public int ID
        {
            get { return iID; }
        }

        [PropertyAttribute(Field = "COD_TIPO_ITEM_REMUNERATORIO", Description = "Código", AllowNull = false, PropertyType = PropertyCategories.Field, Size=2)]
        public char Codigo
        {
            get;
            set;
        ...
        [PropertyAttribute(Field = "DSC_TIPO_ITEM_REMUNERATORIO", Description = "Descrição", AllowNull = false, PropertyType = PropertyCategories.Field, Size = 50)]
        ...
        #region Construtores
        public TipoItem() { }
        public TipoItem(Dao dao)
        {
            oDao = dao;
        }

        public TipoItem(int id, Dao dao)
        {
