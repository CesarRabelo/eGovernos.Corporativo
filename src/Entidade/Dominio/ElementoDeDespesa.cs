...
{
    [ClassAttribute(Schema = "platinium", Table = "TB_ELEMENTO_DESPESA_ELDE")]
    public class ElementoDeDespesa
    {
        ...
        [PropertyAttribute(Field = "ID_ELEMENTO_DESPESA_ELDE", AllowNull = false, PropertyType = PropertyCategories.PrimaryKey, Variable = "iID")]
        public int ID
        {
            get { return iID; }
        }
        ...
        [PropertyAttribute(Field = "COD_ELEMENTO_DESPESA_ELDE", AllowNull = false, Description="Código", PropertyType = PropertyCategories.Field)]
        public string Codigo
        {
            get;
            set;
        }
        [PropertyAttribute(Field = "DSC_ELEMENTO_DESPESA_ELDE", AllowNull = false, Description="Descrição", PropertyType = PropertyCategories.Field)]
        ...
        #region Construtores
        public ElementoDeDespesa() { }
		public ElementoDeDespesa(Dao dao)
		{
			oDao = dao;
		}

        public ElementoDeDespesa(int id, Dao dao)
		{
        ...
        public ElementoDeDespesa(string codigo, Dao dao)
        {
            List<Parameter> parametro = new List<Parameter>();
        ...
        private void ValidarCodigoCadastrado()
        {
            ...
            if (oDao.Select(parametro, "platinium", "TB_ELEMENTO_DESPESA_ELDE", typeof(ElementoDeDespesa)).Rows.Count != 0)
                throw new RegraNegocioException("Elemento de despesa já cadastrado com o código informado");
        }
        ...
        private void ValidarDescricaoCadastrado()
        {
            ...
            if (oDao.Select(parametro, "platinium", "TB_ELEMENTO_DESPESA_ELDE", typeof(ElementoDeDespesa)).Rows.Count != 0)
                throw new RegraNegocioException("Elemento de despesa já cadastrado com a descrição informada");
        }
