...
{
    [ClassAttribute(Schema = "platinium", Table = "TB_TIPO_AMPARO_LEGAL_TIAL")]
    public class TipoAmparo
    {
        ...
        [PropertyAttribute(Field = "ID_TIPO_AMPARO_LEGAL", AllowNull = false, PropertyType = PropertyCategories.PrimaryKey, Variable = "iID")]
        public int ID
        {
            get { return iID; }
        }

        [PropertyAttribute(Field = "COD_TIPO_AMPARO_LEGAL", AllowNull = false, Description = "Código", PropertyType = PropertyCategories.Field)]
        public string Codigo
        {
            get;
            set;
        }
        [PropertyAttribute(Field = "DSC_TIPO_AMPARO_LEGAL", AllowNull = false, Description = "Descrição", PropertyType = PropertyCategories.Field)]
        ...
        #region Construtores
        public TipoAmparo() { }
        public TipoAmparo(Dao dao)
        {
            oDao = dao;
        }

        public TipoAmparo(int id, Dao dao)
        {
        ...
        private void ValidarCodigoCadastrado()
        {
            ...
            if (oDao.Select(parametro, "platinium", "TB_TIPO_AMPARO_LEGAL_TIAL", typeof(TipoAmparo)).Rows.Count != 0)
                throw new RegraNegocioException("Tipo de amparo já cadastrado com o código informado");
        }
        ...
        private void ValidarDescricaoCadastrado()
        {
            ...
            if (oDao.Select(parametro, "platinium", "TB_TIPO_AMPARO_LEGAL_TIAL", typeof(TipoAmparo)).Rows.Count != 0)
                throw new RegraNegocioException("Tipo de amparo já cadastrado com a descrição informada");
        }
