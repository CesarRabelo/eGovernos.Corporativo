...
namespace Platinium.Entidade
{
    ...
    public class Sexo
    {
        ...
        [PropertyAttribute(Field = "DSC_SEXO", Description = "Descrição", AllowNull = false, PropertyType = PropertyCategories.Field)]
        ...
        [PropertyAttribute(Field = "COD_SEXO", Description = "Código", AllowNull = false, PropertyType = PropertyCategories.Field)]
