...
namespace Platinium.Entidade
{
    ...
    public class EconomicaDeReceita
    {
        ...
        #region Construtores
        public EconomicaDeReceita() { }
        public EconomicaDeReceita(Dao dao)
        {
            oDao = dao;
        }

        public EconomicaDeReceita(int id, Dao dao)
        {
        ...
        public EconomicaDeReceita(string codigo, Dao dao)
        {
            List<Parameter> parametro = new List<Parameter>();
        ...
        private void ValidarCodigoCadastrado()
        {
            ...
            if (oDao.Select(parametro, "platinium", "VI_CAT_ECONOMICA_RECE", typeof(EconomicaDeReceita)).Rows.Count != 0)
            {
                throw new RegraNegocioException("Categoria econômica de receita já cadastrada com o código informado");
            }
        }
        ...
        private void ValidarDescricaoCadastrado()
        {
            ...
            if (oDao.Select(parametro, "platinium", "VI_CAT_ECONOMICA_RECE", typeof(EconomicaDeReceita)).Rows.Count != 0)
                throw new RegraNegocioException("Categoria econômica de receita já cadastrada com a descrição informado");
        }
