...
{
    [ClassAttribute(Schema = "platinium", Table = "TB_PODER_PODE")]
    public class Poder
    {
        ...
        [PropertyAttribute(Field = "ID_PODER_PODE", AllowNull = false, PropertyType = PropertyCategories.PrimaryKey, Variable = "iID")]
        public int ID
        {
            get { return iID; }
        }
        ...
        [PropertyAttribute(Field = "COD_PODER", AllowNull = false, Description="Código", PropertyType = PropertyCategories.Field)]
        public string Codigo
        {
            get;
            set;
        }
        [PropertyAttribute(Field = "DSC_PODER", AllowNull = false, Description="Descrição", PropertyType = PropertyCategories.Field)]
        ...
        #region Construtores
        public Poder() { }
		public Poder(Dao dao)
		{
			oDao = dao;
		}

        public Poder(int id, Dao dao)
		{
        ...
        private void ValidarCodigoCadastrado()
        {
            ...
            if (oDao.Select(parametro, "platinium", "TB_PODER_PODE", typeof(Poder)).Rows.Count != 0)
                throw new RegraNegocioException("Poder já cadastrado com o código informado.");
        }
        ...
        private void ValidarDescricaoCadastrado()
        {
            ...
            if (oDao.Select(parametro, "platinium", "TB_PODER_PODE", typeof(Poder)).Rows.Count != 0)
                throw new RegraNegocioException("Poder já cadastrado com a descrição informada.");
        }
