...
{
    [ClassAttribute(Schema = "platinium", Table = "TB_TIPO_MOVIMENTO_TIMO")]
    public class TipoMovimento
    {
        ...
        [PropertyAttribute(Field = "ID_TIPO_MOVIMENTO", AllowNull = false, PropertyType = PropertyCategories.PrimaryKey, Variable = "iID")]
        public int ID
        {
            get { return iID; }
        }

        [PropertyAttribute(Field = "COD_TIPO_MOVIMENTO", AllowNull = false, Description = "Código", PropertyType = PropertyCategories.Field)]
        ...
        [PropertyAttribute(Field = "DSC_TIPO_MOVIMENTO", AllowNull = false, Description = "Descrição", PropertyType = PropertyCategories.Field)]
        ...
        [PropertyAttribute(Field = "FLG_TIPO_MOVIMENTO", AllowNull = false, Description = "Tipo Movimento", PropertyType = PropertyCategories.Field)]
        public string Tipo
        {
            get;
            set;
        ...
        public TipoMovimento(Dao dao)
        {
            oDao = dao;
        }

        public TipoMovimento(int id, Dao dao)
        {
        ...
        public TipoMovimento(string codigo, Dao dao)
        {
            List<Parameter> parametro = new List<Parameter>();
        ...
        private void ValidarCodigoCadastrado()
        {
            ...
            if (oDao.Select(parametro, "platinium", "TB_TIPO_MOVIMENTO_TIMO", typeof(TipoMovimento)).Rows.Count != 0)
        ...
        private void ValidarDescricaoCadastrado()
        {
            ...
            if (oDao.Select(parametro, "platinium", "TB_TIPO_MOVIMENTO_TIMO", typeof(TipoMovimento)).Rows.Count != 0)
                throw new RegraNegocioException("Campo já cadastrada com a descrição informado");
        }
