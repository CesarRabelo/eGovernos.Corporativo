...
{
    [ClassAttribute(Schema = "platinium", Table = "tb_eixo_eixo")]
    public class Eixo
    {
        ...
        [PropertyAttribute(Field = "ID_EIXO_EIXO", AllowNull = false, PropertyType = PropertyCategories.PrimaryKey, Variable = "iID")]
        public int ID
        {
            get { return iID; }
        }
        ...
        [PropertyAttribute(Field = "COD_EIXO", AllowNull = false, Description = "Código", PropertyType = PropertyCategories.Field)]
        public string Codigo
        {
            get;
            set;
        }
        [PropertyAttribute(Field = "DSC_EIXO", AllowNull = false, Description = "Descrição", PropertyType = PropertyCategories.Field)]
        ...
        private void ValidarCodigoCadastrado()
        {
            ...
            if (oDao.Select(parametro, "platinium", "TB_EIXO_EIXO", typeof(Eixo)).Rows.Count != 0)
                throw new RegraNegocioException("Eixo já cadastrado com o código informado");
        }
        ...
        private void ValidarDescricaoCadastrado()
        {
            ...
            if (oDao.Select(parametro, "platinium", "TB_EIXO_EIXO", typeof(Eixo)).Rows.Count != 0)
                throw new RegraNegocioException("Eixo já cadastrado com a descrição informada");
        }
