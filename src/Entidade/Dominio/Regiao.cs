...
{
    [ClassAttribute(Schema = "platinium", Table = "TB_REGIAO_REGI")]
    public class Regiao
    {
        ...
        [PropertyAttribute(Field = "ID_REGIAO_REGI", AllowNull = false, PropertyType = PropertyCategories.PrimaryKey, Variable = "iID")]
        public int ID
        {
            get { return iID; }
        }
        ...
        [PropertyAttribute(Field = "COD_REGIAO", AllowNull = false, Description="Código", PropertyType = PropertyCategories.Field)]
        public string Codigo
        {
            get;
            set;
        }
        [PropertyAttribute(Field = "DSC_REGIAO", AllowNull = false, Description="Descrição", PropertyType = PropertyCategories.Field)]
        ...
        #region Construtores
        public Regiao() { }
		public Regiao(Dao dao)
		{
			oDao = dao;
		}

        public Regiao(int id, Dao dao)
		{
        ...
        private void ValidarCodigoCadastrado()
        {
            ...
            if (oDao.Select(parametro, "platinium", "TB_REGIAO_REGI", typeof(Regiao)).Rows.Count != 0)
                throw new RegraNegocioException("Região já cadastrada com o código informado");
        }
        ...
        private void ValidarDescricaoCadastrado()
        {
            ...
            if (oDao.Select(parametro, "platinium", "TB_REGIAO_REGI", typeof(Regiao)).Rows.Count != 0)
                throw new RegraNegocioException("Região já cadastrada com a descrição informada");
        }
