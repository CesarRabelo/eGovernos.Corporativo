...
namespace Platinium.Entidade
{
    ...
    public class Orgao
    {
        ...
        #region Construtores
        public Orgao() { }
        public Orgao(Dao dao)
        {
            oDao = dao;
        }

        public Orgao(int id, Dao dao)
        {
        ...
        {            
            ...
            if (oDao.Select(parametro, "platinium", "VI_ORGAO_ORGA", typeof(Orgao)).Rows.Count != 0)
                throw new RegraNegocioException("Orgão já cadastrado com o código informado.");
        }
        ...
        private void ValidarDescricaoCadastrada()
        {
            ...
            if (oDao.Select(parametro, "platinium", "VI_ORGAO_ORGA", typeof(Orgao)).Rows.Count != 0)
                throw new RegraNegocioException("Orgão já cadastrado com a descrição informada.");
        }
